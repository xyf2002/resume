...
%
%\begin{itemize}
%  \item \textbf{Yufeng Xia}, et al. ``WASP: Foundation Model Training System for the Edge.'' \textit{SEC 2026 (Under Review).}
%  \item \textbf{Yufeng Xia}, et al. ``Morphling: Emulator for Distributed Machine Learning at the Edge.'' \textit{EdgeSys 2026.}
%  \item \textbf{Yufeng Xia}, et al. ``Weaver: Foundation Model Training over AI-RAN Compute Infrastructure.'' \textit{MobiCom 2026 (Under Review).}
%  \item \textbf{Yufeng Xia}, et al. ``EmuRAN: Scalable and Cost-Effective Cloud-based RAN Emulation System.'' \textit{MobiCom 2026 (Under Review).}
%\end{itemize}
