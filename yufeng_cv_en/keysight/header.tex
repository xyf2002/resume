...
\section{Profile}
  \begin{itemize}[leftmargin=*]
    ...
    \par\vspace{3pt}
    I build the layer between the radio and the model, making live network behaviour something models can be trained and validated against, and idle radio compute something they can run on. This work has been published at ACM MobiCom and EdgeSys (Best Paper), and I am especially interested in where it goes in 6G. \textbf{Available for a full-time internship from September 2026.}}
  \end{itemize}
