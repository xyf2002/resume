...
\section{Profile}
  \begin{itemize}[leftmargin=*]
    ...
    \par\vspace{3pt}
    I build the layer between the radio and the model --- making live network behaviour something models can be trained and validated against, and idle mpute something they can run on. Grounded in C/C++, Linux and GPU systems engineering, with research at ACM MobiCom and EdgeSys (Best Paper). \textbf{Available for a full-time internship from September 2026.}}
  \end{itemize}
